...
/* harmony import */ var _skip_link_focus_fix_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./skip-link-focus-fix.js */ "./assets/js/skip-link-focus-fix.js");
...
(function ($) {
  ...
  */
  ...
  $('#main-navigation > ul > .menu-item-has-children > a').after('<button aria-expanded="false" aria-label="Laajenna" class="toggle-sub second"><i class="open close" aria-hidden="true"></i></button>'); // when mouse enters lvl 2 toggle item -> show menu
  ...
  $('.toggle-sub.second').click(function () {
    ...
    if (!$(this).hasClass('expanded')) {
      ...
      // If clicked submenu is already open -> hide it
      hideAllSubMenus();
    }
  });
  /*
  ...
  */
  ...
  $('#main-navigation .sub-menu .menu-item-has-children > a').after('<button aria-expanded="false" aria-label="Laajenna" class="toggle-sub third"><i class="open close" aria-hidden="true"></i></button>'); // when mouse enters lvl 3 toggle item -> show menu
  ...
  */
  ...
  var target = document.querySelector('#main-navigation');
...
/******/ 	__webpack_require__.O(undefined, ["admin","bundle"], () => (__webpack_require__("./assets/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["admin","bundle"], () => (__webpack_require__("./assets/styles/app.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["admin","bundle"], () => (__webpack_require__("./assets/styles/admin.css")))
